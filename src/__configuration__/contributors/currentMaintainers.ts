...
export const currentMaintainers: CurrentMaintainter[] = [
    ...
    },
    {
        ...
        role: `Front-End Developer`,
        image: SurajKarambe,
        description: `Suraj is a techie, who primarily works on the front-end technologies from last ${
            new Date().getFullYear() - 2017
        } years. He loves to trek and travel with the friends and has his roots in India. He is a big foodie and also likes to watch movies and television series.`,
        contacts: {
